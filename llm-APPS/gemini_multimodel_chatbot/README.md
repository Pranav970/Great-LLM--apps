...
3.  **Get your Google AI Studio API Key:**
    ...
    *   Sign up for a Google AI Studio account and obtain your API key.  You will need to set this as an environment variable (see instructions in the main script).
